							...
							<div class="projectSummary projectBox">
								...
								<div class="summaryInfo">
									<div class="basicInfo">
										...
										<c:if test="${project.metadata.gradeRange != null && project.metadata.gradeRange != ''}">年級： ${project.metadata.gradeRange} | </c:if>
										<c:if test="${project.metadata.totalTime != null && project.metadata.totalTime != ''}">授課時數： ${project.metadata.totalTime} 小時| </c:if>
									...
									<div class="details" id="details_${project.id}">
										...
										<c:if test="${project.metadata.techDetailsString != null && project.metadata.techDetailsString != ''}"><p><span style="font-weight:bold;">科技需求</span> ${project.metadata.techDetailsString}</p></c:if>
